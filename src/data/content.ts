export const personal = {
  ...
  /** Short hero blurb */
  heroIntro:
    "I'm at San José State (grad May 2027). Most of what I build lives on STM32 or ESP32: motors, sensors, serial debug, flash layouts, that kind of thing. I like the boring parts too: bring-up, logging, figuring out why the board does something weird at 2am.",
}
...
export const about = {
  paragraphs: [
    ...
    "I'm trying to land an internship where I can keep doing that kind of work next to people who've been doing it longer than I have.",
  ],
}
...
export const experience: Experience[] = [
  {
    company: 'Robotics Club at San José State University',
    role: 'Embedded contributor',
    location: 'San Jose, CA',
    period: 'Aug 2025 to present',
    bullets: [
      'I2C/SPI bring-up on club boards: LA on the desk, serial on the screen.',
      'Chasing power-up order and noise when sensors and drivers share a messy harness.',
      'Wiring diagrams + test notes in Git so the next revision isn’t starting from memory.',
    ],
  },
  {
    company: 'Independent',
    role: 'Embedded projects (personal)',
    location: 'San Jose, CA',
    period: 'Jan 2025 to present',
    bullets: [
      'Three repos I actually flash: bootloader, RTOS hub, ESP32 hand.',
      'Drivers and linker scripts when the stock HAL layout isn’t enough.',
      'CLI + telemetry patterns I’ve copied into club work when it saved time.',
    ],
  },
]
...
export const contact = {
  heading: 'Contact',
  description:
    "I'm looking for Summer 2026 internships in embedded, firmware, or robotics software. If your team lives in schematics and `.c` files, I'd like to talk.",
}
